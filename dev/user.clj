...
(def index
  "notebooks/mentat_collective/clerk_utils_custom_template.clj")
...
(def defaults
  {;; NOTE by default, your project's first notebook is registered as its index;
   ...
   :index index
   :cljs-namespaces
   '[mentat-collective.sci-extensions]})
...
(def static-defaults
  (assoc defaults
         ...
         :cname ""
         :git/url "https://github.com/mentat-collective/clerk-utils-custom-template"))
