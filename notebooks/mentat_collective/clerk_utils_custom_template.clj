...
(ns mentat-collective.clerk-utils-custom-template
...
;; function `square` defined in `src/mentat_collective/custom.cljs`:
...
;; This is made possible by the code in `src/mentat_collective/sci_viewers.cljs`. If
