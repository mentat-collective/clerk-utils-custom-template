...
```clj
(clerk/show! "notebooks/mentat_collective/clerk_utils_custom_template.clj")
```
...
All ClojureScript code you add to `src/mentat_collective/custom.cljs` is available
for use inside any [custom viewer code you
write](https://book.clerk.vision/#writing-viewers).

This is made possible by the code in `src/mentat_collective/sci_viewers.cljs`. If you
...
- [Create a GitHub repository](https://github.com/new). Ideally the owner
  matches `mentat-collective` and the project name is `clerk-utils-custom-template`.
...
git branch -M main
git remote add origin git@github.com:mentat-collective/clerk-utils-custom-template.git
git push -u origin main
```

Then visit https://github.com/mentat-collective/clerk-utils-custom-template to see your site.
...
By default your site will live at https://mentat-collective.github.io/clerk-utils-custom-template.
...
https://github.clerk.garden/mentat-collective/clerk-utils-custom-template
